...
obscene, objectionable, offensive, discriminatory, invalid or untruthful output; Content; Value Chain and
...
system introduces significant new security vulnerabilities; Anticipated system Dangerous, Violent, or Hateful
...
GV-1.5-003 validation, and verification (TEVV), and digital content transparency methods for
Property
GAI.
...
Define any inventory exemptions in organizational policies for GAI systems Value Chain and Component
GV-1.6-002
...
retention requirements; Data security, e.g., containment, protocols, Data leakage Human-AI Configuration;
...
incidents and performance to AI Actors and downstream stakeholders (including Human-AI Configuration; Value
GV-2.1-001
those potentially impacted), via community or official resources (e.g., AI incident Chain and Component Integration
...
GV-2.1-003 Human-AI Configuration
...
stages of large or complex GAI systems, including: Test and evaluation, validation, Human-AI Configuration;
...
GV-3.2-004 Human-AI Configuration
...
risks.
Action ID Suggested Action GAI Risks
Allocate time and resources for outreach, feedback, and recourse processes in GAI Human-AI Configuration; Harmful
GV-5.1-001
system development. Bias and Homogenization
Document interactions with GAI systems to users prior to interactive activities, Human-AI Configuration;
GV-5.1-002
