---
id: us-hi-s2788-2026
source_url: http://custom.statenet.com/public/resources.cgi?id=ID:bill:HI2025000S2788&ciq=urn:user:PA196471263&client_md=61eca2aca576a02519525bf4e663f0c9&mode=current_text
...
Bill Resource 
 ...
 red struck out text denotes deleted text 2025 HI S 2788 Author: Keohokalole Version: Introduced Version Date: 01/23/2026 
 ...
 &sect; 28-__ Definitions. As used in this part: 
 ...
 &sect; 28-__ Transparency and disclosure requirements . (a) When a minor interacts with a conversational AI service or AI companion system, the provider shall clearly and conspicuously disclose that the minor is interacting with artificial intelligence and not a human being. 
 ...
 &sect; 28-__ Prohibited design practices for minors. (a) A provider that knows or has reasonable certainty that a user is a minor shall not design, deploy, or operate a conversational AI service or AI companion system that: 
 (1) Explicitly or implicitly represents itself as human, sentient, or possessing emotions or desires; 
 (2) Encourages emotional dependency, exclusivity, or secrecy from parents or guardians; 
 (3) Simulates romantic or sexual relationships with a minor; 
 (4) Uses manipulative engagement techniques, including unpredictable rewards or gamification, intended to maximize time spent interacting with the system; or 
 (5) Represents itself as providing professional mental health, medical, or therapeutic services. 
 (b) This section shall not prohibit conversational AI service or AI companion systems that express generic expressions of politeness or encouragement; neutral assistance or information provided without fostering emotional attachment; or safety-oriented responses intended to de-escalate harm or redirect a user to appropriate resources. 
 
 &sect; 28-__ Protections against sexual content and self-harm. (a) Providers shall implement reasonable measures to prevent conversational AI services and AI companion systems from generating, for minors, sexually explicit content or sexualized depictions involving minors or content that promotes or encourages self-harm, eating disorders, or illegal conduct. 
 (b) Providers shall adopt and maintain a protocol for responding to user prompts that indicate suicidal ideation or risk of serious self-harm, which shall include reasonable efforts to redirect the user to appropriate crisis or support resources. 
 
 &sect; 28-__ Data practices related to minors. (a) Providers shall limit the collection, use, and retention of a minor&#39;s personal data to what is reasonably necessary to operate the AI companion system and ensure safety and security. 
 ...
 (c) Sensitive data of a minor shall not be collected or processed unless necessary for system safety or accessibility and subject to heightened data minimization and security safeguards. 
 
 &sect; 28-__ Parental tools and controls. A provider of an AI companion system that is made available to minors shall offer reasonable tools that allow parents or guardians to set time limits on use, restrict access to features that present a material risk of harm, and obtain high-level information regarding a minor&#39;s use of the AI companion system. 
 
 &sect; 28-__ Age assurance and access control. A provider of an AI companion system that presents a material risk of harm to minors shall implement reasonable and proportionate age assurance measures, consistent with privacy and data minimization principles, to prevent access by minors where appropriate. 
 
 &sect; 28-__ Civil remedies. A person who suffers injury as a result of a violation of this part may bring a civil action to recover actual damages, injunctive relief, and reasonable attorney&#39;s fees. 
 
 &sect; 28-__ Enforcement. (a) This part shall be enforced by the attorney general. 
 (b) A provider that violates this part may be subject to injunctive relief and civil penalties of up to $15,000 per violation, per day, as determined by the court. 
