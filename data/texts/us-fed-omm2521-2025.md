...
The requirements in this section are consistent with the following laws and policies: AI in Government Act of
...
trustworthy AI, ensuring that rapid AI innovation is not achieved at the expense of the American
...
4 Consistent with provisions of the AI in Government Act of 2020, which required the issuance of this
...
5 The term "agency," as used in both the AI in Government Act of 2020 and the Advancing American AI Act, is
...
regulatory actions designed to prescribe law or policy regarding non-agency uses of AI; 6
assessments of particular AI applications because the AI provider is the target or potential
target of a regulatory enforcement, law enforcement, or national security action; 7
development of metrics, methods, and standards to test and measure AI, where such
metrics, methods, and standards result in use by the general public or the government as a
whole; or
use of AI to carry out basic research or applied research, except where the purpose of
...
For guidance on regulatory and non-regulatory approaches to AI applications developed and deployed outside of
...
available on the agency's website. To ensure accountability to the taxpayer, strategies should be
...
current and planned AI use cases that are most impactful to an agency's mission,
operations, or service delivery;9

11.

an assessment of the agency's current state of AI maturity and a plan to achieve the
agency's AI maturity goals, by addressing, at a minimum, plans or processes to:
A. develop AI-enabling infrastructure 10 across the AI lifecycle including development,
testing, deployment, continuous monitoring; 11
B. ensure access to quality data 12 for AI and data traceability; 13
...
to better address the needs of AI applications.
...
Encouraging Reuse of AI Code and Models. Agencies must proactively share across the
...
public repository 15 unless the:
...
Sharing and Releasing AI Data Assets. Data used to develop and test AI may constitute a
...
Based Policymaking Act of2018: Open Government Data Access and Management
Guidance. 16
111.

Unintended Disclosure of Data from AI Models. Consistent with Section 2( d)(i), agencies
...
Maximizing the Value of Data for AI. In contracts for AI products and services, agencies
...
Performance Improvement. Agencies, where practicable, are encouraged to better track
...
A. documenting known capabilities and limitations of the AI and any guidelines on how
...
Promoting Competition in Federal Procurement of AI. Agencies should adopt
...
Leveraging AI Trainings and Resources to Upskill Existing Staff. Agencies should
...
Promoting AI Talent. Agencies should focus recruitment efforts on individuals that have
demonstrated operational experience in designing, deploying, and scaling AI systems in
high-impact environments.

111.

Ensuring Accountability. Agencies, in coordination with relevant agency officials, should
...
Chief AI Officers. Within 60 days of the issuance of this memorandum, the head of each
...
Agency AI Governance Board. Within 90 days of the issuance of this memorandum, each
...
Empower Agency AI Leaders. Agencies must enable trained and accountable agency
officials at the lowest appropriate level21 to identify, assess, mitigate, and accept risk for
AI use cases. 22

11.

Develop Compliance Plans. Consistent with Section 104(c) and (d) of the AI in
...
Update Agency Policies. Within 270 days of the issuance of this memorandum, agencies
...
Develop Generative AI Policy. Within 270 days of the issuance of this memorandum,
...
Update AI Use Case Inventories. Each agency (except for the Department of Defense and
...
Strategic Resource, https://bidenwhitehouse.archives.gov/wpcontent/uploads/legacy drupal files/omb/circulars/A 130/a 130revised.pdf.
...
their current use of AI. 0MB will issue detailed instructions to agencies regarding the
...
Chief AI Officer Council. Within 90 days of the issuance of this memorandum, the
...
Office of the Director of National Intelligence, and other agencies as identified by the
Chair;
...
Community .25 Consistent with these goals, agencies must undertake the following, in addition to
...
Implementing Risk Management Practices and Termination of Non-Compliant AI.
...
by 0MB. If a particular high-impact use case is not compliant with the minimum
...
Authorizing Waivers from Minimum Practices for High-Impact AI. In coordination with
...
Tracking Waivers from Minimum Practices for High-Impact AI. In addition to the
...
Publicly Reporting Determinations and Waivers. To the extent consistent with law and
...
Conduct Pre-Deployment Testing. Agencies must develop pre-deployment testing and
...
alternative test methodologies, such as querying the AI service and observing the outputs
or providing evaluation data to the vendor and obtaining results.
11.

Complete AI Impact Assessment. Agencies must complete an AI impact assessment
...
D. reassessment scheduling and procedures, supported by schedules for periodic
...
Provisions ofthe £-Government Act of2002, https://bidenwhitehouse.archives.gov/wpcontent/uploads/legacy drupal files/omb/memoranda/2003/m03 22.pdf.
...
Conduct Ongoing Monitoring for Performance and Potential Adverse Impacts. Agencies
...
Ensure Adequate Human Training and Assessment. Agencies must ensure there is
...
Provide Additional Human Oversight, Intervention, and Accountability. Agencies must
...
Offer Consistent Remedies or Appeals. Agencies must ensure that individuals affected by
...
Consult and Incorporate Feedback from End Users and the Public. Agencies must
...
data system, software, application, tool, or utility that operates in whole or in part using dynamic
...
PURPOSES FOR WHICH AI IS PRESUMED TO BE HIGH-IMPACT
...
1.
The blocking, removal, hiding, or limitation of the reach of protected speech;
...
n. Determination of the terms or conditions of Federal employment, including pre­
...
METHODS OF UNDERSTANDING AI RISK MANAGEMENT
...
AI outputs that discriminate on the basis of a protected characteristic;
AI outputs that contribute to actions or decisions resulting in harmful or unsafe outcomes,
...
processes.
34 Information on post-transaction customer feedback surveys can be found in 0MB Circular A-11, Section 280 Managing Customer Experience and Improving Service Delivery,
...
Retain or designate a Chief AI Officer.
...
Convene relevant agency officials to coordinate
and govern issues tied to the use of AI within
...
Convene a Chief AI Officer Council, led by the
...
Develop and release publicly an agency strategy 2(a)
for removing barriers to the use of AI and
...
Submit to 0MB and release publicly an agency
...
Update internal policies on IT infrastructure,
...
Implement the minimum risk management
...
Report directly to 0MB any determinations and
waivers that are granted or revoked.

4(a)(iii)

Annually and 30days after significant
modifications

Each Agency *

Publicly report determinations and waivers for
AI use cases.
...
Publicly release an AI use case inventory
consistent with 0MB instructions.
