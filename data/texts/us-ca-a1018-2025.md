---
id: us-ca-a1018-2025
source_url: http://custom.statenet.com/public/resources.cgi?id=ID:bill:CA2025000A1018&ciq=urn:user:PA196471263&client_md=671b916d99bfd868b451dced2c646c5a&mode=current_text
...
Bill Resource 
 ...
 red struck out text denotes deleted text 2025 CA A 1018 Author: Bauer-Kahan Version: Amended Version Date: 09/05/2025 
 ...
 This bill would require a developer of a covered ADS, as defined, to take certain actions, including conduct performance evaluations 
 impact assessments of the covered ADS and provide deployers to whom the developer transfers the covered ADS with certain information, including a high-level summary of the results of those performance evaluations. 
 impact assessments. 
 ...
 This bill would require a developer, deployer, or auditor to, within 30 days of receiving a request from the Attorney General, provide an unredacted copy of the performance evaluation 
 impact assessment prepared pursuant to the bill to the Attorney General and would exempt those records from the California Public Records Act. 
 ...
 24.6. Automated Decisions Safety Act 
 ...
 (2) &quot;Automated decision system&quot; does not mean 
 include a spam email filter, firewall, antivirus software, identity and 
 verification or access management tool, calculator, database, dataset, spreadsheet, document validation or authenticity tool, or other compilation of data. 
 data or information. 
 ...
 (d) (1) &quot;Covered automated decision system&quot; or &quot;covered ADS&quot; means an automated decision system that is designed or used to 
 for, or used by, a deployer to profile a natural person in order for the deployer to make or facilitate a consequential decision. 
 
 (2) &quot;Covered ADS&quot; does not mean a GenAI system that is not intended or advertised to make or facilitate a consequential decision. 
 ...
 (f) &quot;Deployer&quot; means a person, partnership, state or local government agency, corporation, or developer that uses a covered ADS to make or facilitate a consequential decision, either directly or by contracting with a third party for that purpose. 
 ...
 (2) &quot;Developer-approved use&quot; includes any reasonably foreseeable fine tuning 
 fine-tuning of the covered ADS. 
 ...
 (l) (1) &quot;Express consent&quot; means an affirmative written authorization that is granted in response to a notice that is all 
 ...
 (2) &quot;Express consent&quot; does not mean 
 include an authorization that is either 
 ...
 (n) &quot;GenAI system&quot; means an artificial intelligence system that can generate derived synthetic content, including text, images, video, and audio, that emulates the structure and characteristics of the system&#39;s training data. 
 
 
 (n) 
 
 
 (o) &quot;Labor Commissioner&quot; means Chief of the Division of Labor Standards Enforcement. 
 
 (o) 
 
 
 (p) &quot;Personal information&quot; has the same meaning as defined in Section 1798.140 of the Civil Code. 
 
 (q) &quot;Profile&quot; means to use a covered ADS that does both of the following: 
 ...
 (r) &quot;Protected characteristic&quot; means a characteristic listed in subdivision (b) of Section 51 of the Civil Code. 
 
 (q) 
 
 
 (s) (1) &quot;Substantial modification&quot; means a new version, release, update, or other modification to a covered ADS that materially changes its uses or outputs. 
 (2) &quot;Substantial modification&quot; does not mean 
 include a modification that results from fine tuning. 
 fine-tuning. 
 ...
 (t) &quot;Trade secret&quot; has the same meaning as in Section 3426.1 of the Civil Code. 
 
 (s) 
 
 
 (u) The definitions of &quot;disparate impact&quot; and &quot;disparate treatment&quot; provided in subdivisions (i) and (j) are intended solely for purposes of internal compliance, risk assessment, and documentation required by this chapter. These definitions shall not be construed to modify or supersede any standard, burden of proof, or element of a claim under the Unruh Civil Rights Act (Section 51 of the Civil Code), the California Fair Employment and Housing Act (Part 2.8 (commencing with Section 12900) of Division 3 of Title 2 of the Government Code), Title VII of the Civil Rights Act of 1964 (42 U.S.C. Sec. 2000e et seq.), or any other applicable civil rights law. 
 22756.1. (a) (1) With respect to a covered ADS that was first deployed, or made available to potential deployers, before January 1, 2026, the developer of the covered ADS shall conduct an initial performance evaluation 
 impact assessment on the covered ADS before January 1, 2027, and annually thereafter. 
 (2) With respect to a covered ADS that is first deployed or made available to potential deployers on or after January 1, 2026, the developer of the covered ADS shall conduct a performance evaluation 
 an impact assessment on the covered ADS before initially deploying the covered ADS, or making the covered ADS available to potential deployers, and annually thereafter. 
 (b) In conducting a performance evaluation 
 an impact assessment on a covered ADS, a developer shall do all of the following: 
 (1) Describe the purpose of the covered ADS. 
 (2) List and describe all developer-approved uses of the covered ADS. 
 (3) For each developer-approved use, evaluate the expected performance of the covered ADS and document all of the following: 
 ...
 (ii) Whether each category of disparate treatment is necessary for a 
 the developer-approved use. 
 ...
 (ii) Whether each category of disparate impact is necessary for a 
 the developer-approved use. 
 ...
 (4) (A) Beginning January 1, 2030, contract with an independent third-party auditor to assess the developer&#39;s compliance with this subdivision. 
 subdivision and complete an audit within six months of the most recent impact assessment and two years after completion of the initial audit. 
 ...
 (C) If the deadline for conducting a performance evaluation pursuant to subdivision (a) 
 an impact assessment or audit elapses before the impact assessment or audit has been completed, a developer shall not deploy the covered ADS or make the covered ADS available to potential deployers until the impact assessment or audit has been completed. 
 (D) A developer that receives feedback from an auditor pursuant to this paragraph shall do both of the following: 
 (i) Consider and attempt to incorporate that feedback into the development of any subsequent version of a covered ADS. 
 (ii) Make a high-level summary of the feedback publicly available at no cost to users of the developer&#39;s internet website. 
 ...
 (1) A high-level summary of the results of the most recent performance evaluation 
 impact assessment conducted on the covered ADS by the developer pursuant to this chapter. 
 
 (B) 
 
 
 (2) For each developer-approved use of the covered ADS, instructions explaining how the covered ADS should be used by the deployer to make or facilitate a consequential decision. 
 
 (C) 
 
 
 (3) For each developer-approved use of the covered ADS, a description of whether and under what circumstances the covered ADS can be fine-tuned. 
 
 (D) 
 
 
 (4) An explanation of the deployer&#39;s responsibilities under this chapter, including a description of any circumstances under which the deployer would assume the responsibilities of a developer pursuant to subdivision (h) 
 (f) of Section 22756.2. 
 
 (E) (i) 
 
 
 (5) (A) Any technical information necessary for the deployer to comply with this chapter. 
 
 (ii) 
 
 
 (B) A developer shall not be required to provide additional technical information to a deployer that has assumed the responsibilities of a developer pursuant to subdivision (h) 
 (f) of Section 22756.2. 
 ...
 (1) Any material differences between the expected accuracy of the covered ADS and the observed accuracy of the covered ADS and the deployment conditions under which those differences are reasonably likely to occur. 
 
 
 (2) Any material differences between the expected reliability of the covered ADS and the observed reliability of the covered ADS and the deployment conditions under which those differences are reasonably likely to occur. 
 
 
 (3) Any unanticipated disparate impacts resulting from the use of the covered ADS and the deployment conditions under which those disparate impacts are reasonably likely to occur. 
 
 
 (4) An explanation of any steps the deployer can take to mitigate these discrepancies. 
 ...
 (d) A developer that provides documentation to a deployer pursuant to this section shall ensure the documentation is all of the following: 
 ...
 (e) A developer that deploys a covered ADS or makes a covered ADS available to potential deployers shall maintain all of the following documentation in an unredacted format for as long as the developer deploys the covered ADS or makes the covered ADS available to potential deployers plus 10 
 five years: 
 (1) The results of any performance evaluations 
 impact assessments conducted on the covered ADS pursuant to this chapter. 
 ...
 (f) It is unlawful to advertise to consumers in the state that a covered ADS is capable of performing in a manner not substantiated by the results of the most recent performance evaluation 
 impact assessment conducted on the covered ADS. 
 
 (i) 
 
 
 (g) (1) A developer that deploys a covered ADS or makes a covered ADS available to potential deployers shall designate at least one employee to oversee the developer&#39;s compliance with this chapter. 
 ...
 (h) This section does not apply to a developer subject to the federal Gramm-Leach-Bliley Act (15 U.S.C. Sec. 6801 et seq.) who uses 
 with respect to a covered ADS that is intended to make or facilitate a consequential decision related to financial services, as described in paragraph (7) of subdivision (c) of Section 22756. 
 22756.2. (a) (1) Except as provided in paragraph (2), before a deployer finalizes a consequential decision made or facilitated by a covered ADS, 
 ADS used by the deployer, the deployer shall provide any subject of that decision with a plain language written disclosure containing all of the following information: 
 ...
 (C) Whether the deployer&#39;s use of the covered ADS is within the scope of a developer-approved use and a description of that use. 
 ...
 (ii) The sources of personal information collected from the subject that will be used to make or facilitate the consequential decision. 
 (iii) Any key parameters known to disproportionately affect the outcome of the consequential decision. 
 (E) The structure and format of the outputs of the covered ADS and a plain language description of how those outputs are 
 will be used to make or facilitate the consequential decision. 
 ...
 (G) The subject&#39;s rights under subdivisions (b) and (d) 
 subdivision (c) and the means and timeframe for exercising those rights. 
 ...
 (b) (1) After a deployer finalizes a consequential decision made or facilitated by a covered ADS, the deployer shall provide any subject of that decision with&ensp;a plain language written disclosure containing all of the following information within five days: 
 (A) The personal characteristics or attributes of the subject that the covered ADS used 
 measured or assessed to make or facilitate the consequential decision. 
 ...
 (F) Whether a natural person reviewed either of the following before the consequential decision was finalized: 
 ...
 (G) Contact information for the deployer. 
 
 (G) 
 
 
 (H) Contact information for the entity that manages the covered ADS, if that entity is not the deployer. 
 
 (H) 
 
 
 (I) Contact information for the entity that will interpret the results of the covered ADS, if that entity is not the deployer. 
 
 (I) 
 
 
 (J) The subject&#39;s rights under subdivision (d) 
 (c) and the means and timeframe for exercising those rights. 
 (2) Paragraph (1) does not apply if the subject of the consequential decision is having a medical emergency. 
 ...
 (B) The sorting by a covered ADS of r&eacute;sum&eacute;s based on bona fide occupational qualifications. 
 ...
 (c) After a deployer finalizes a consequential decision made or facilitated by a covered ADS, the deployer shall provide any subject of that decision with an opportunity to do both of the following within 30 business days: 
 (1) (A) Correct any incorrect personal information used by the covered ADS to make or facilitate the consequential decision. 
 (B) A deployer shall comply with 
 respond to a request to correct personal information within 30 business days of receiving the request if the request is accompanied by documentation sufficient to assess the basis for the request. 
 ...
 (D) A deployer that denies a request to correct personal information 
 determines that rectifying the decision is infeasible shall do both of the following: 
 ...
 (g) A deployer that uses a covered ADS to make or facilitate a consequential decision shall retain the following documentation in an unredacted format for as long as the deployer uses the covered ADS plus 10 
 five years: 
 ...
 (5) Any documentation provided to, or received from, auditors pursuant to this chapter. 
 (6) Records of any redactions made pursuant to this section. 
 (h) (1) A deployer that uses a covered ADS to make or facilitate a consequential decision shall designate at least one employee to oversee the deployer&#39;s compliance with this chapter. 
 (2) A deployer shall require an employee designated pursuant to this subdivision to conduct a prompt and comprehensive review of any credible compliance issue related to the deployer&#39;s use of a covered ADS that is raised to that employee. 
 (i) In addition to the requirements of this section, a deployer that is a business subject to the California Consumer Privacy Act of 2018 (Title 1.81.5 (commencing with Section 1798.100)) is subject to any privacy-related opt-out and access regulation duly adopted by the California Privacy Protection Agency pursuant to paragraph (15) of subdivision (a) of Section 1798.185 of, and subdivision (b) of Section 1798.199.40 of 
 of, the Civil Code. 
 (j) This section shall become operative on January 1, 2027. 
 22756.3. (a) (1) Within 30 days of receiving a request from the Attorney General for a performance evaluation 
 an impact assessment prepared pursuant to this chapter, a developer, deployer, or auditor of a covered ADS shall provide an unredacted copy of the performance evaluation 
 impact assessment to the Attorney General. 
 (2) The Attorney General may share performance evaluations 
 impact assessments with other enforcement entities as necessary for enforcement purposes. 
 (b) (1) The disclosure or sharing of a performance evaluation 
 an impact assessment pursuant to subdivision (a) does not constitute a waiver of any attorney-client privilege, work-product protection, or trade secret protection that might otherwise exist with respect to any information contained in the performance evaluation. 
 impact assessment. 
 
 (2) A performance evaluation 
 An impact assessment disclosed or shared pursuant to subdivision (a) is exempt from the California Public Records Act (Division 10 (commencing with Section 7920.000) of Title 1 of the Government Code). 
 (c) Each day a covered ADS is used for which a performance evaluation 
 an impact assessment has not been submitted to the Attorney General pursuant to this section is an additional violation of this section. 
 22756.4. (a) Any of the following public entities may bring a civil action against a developer, deployer, or auditor who violates this chapter: 
 ...
 22756.5. (a) This chapter does not apply to an automated decision system the sole purpose of which is to do either 
 any of the following: 
 ...
 (4) Detect, protect against, or respond to suspected or actual fraudulent electronic payment transactions. 
 ...
 (i) In an action alleging a violation of this section in which the defendant&#39;s development, modification, or use of an automated decision system, as defined in Section 22756 of the Business and Professions Code, is alleged to have caused or facilitated the violation, the extent to which the defendant complied with Chapter 24.6 (commencing with Section 22756) of Division 8 of the Business and Professions Code is relevant to, but not conclusive of, whether the defendant violated this section, and a failure to comply with Chapter 24.6 (commencing with Section 22756) of Division 8 of the Business and Professions Code shall not, by itself, give rise to a presumption of unlawful intent. 
